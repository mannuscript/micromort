...
class Parser:
    ...
    def __get_shares(self, article_url):
        ...
        if "http://www.straitstimes.com" in article_url:
            caller = get_straitstimes_a2a_counts
        elif "http://www.channelnewsasia.com" in article_url:
...
if __name__ == "__main__":
    parser = Parser()
    # parser.main();
    print parser.get_shares("http://www.straitstimes.com/lifestyle/anger-over-influencers-sponsored-wedding", "straitstimes")
